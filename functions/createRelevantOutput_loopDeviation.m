function [T] = createRelevantOutput_loopDeviation(model,solution,name)
s = name; 
%%
...
[minFlux, maxFlux] = fluxVariability(model, [], [], {'SK_PHAg_c'});
min_sinkPHA = minFlux(1);
max_sinkPHA = maxFlux(1);

%T = table(Gluc,NH4,OUR, CO2,GrowthRate,a6_8_12_pro,c6_8_10_pro,a6_8_12_dem,c6_8_10_dem,sinkPHA,'RowNames',SimulationRun);

%T = table(Gluc,NH4,OUR, CO2,GrowthRate, a6,a8 ,a10,a12,c6,c8,c10,ad6,ad8,ad10,ad12,cd6,cd8,cd10,sinkPHA,min_sinkPHA,max_sinkPHA,'RowNames',SimulationRun);

T = table(Gluc,NH4,OUR, CO2,GrowthRate, a6,a8,c6,c8,c10,sinkPHA,min_sinkPHA,max_sinkPHA,'RowNames',SimulationRun);
end
