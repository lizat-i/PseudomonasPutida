...
%C Sources = glucose
    ...
    iJN1462_GLC_UR6_3   = changeRxnBounds(iJN1462_GLC_UR6_3,'EX_glc__D_e',-6.3,'u')     ;
    
    
    iJN1462_GLC_UR7_3   = changeRxnBounds(iJN1462_GLC_UR7_3,'EX_glc__D_e',-7.3,'l')     ;
    iJN1462_GLC_UR7_3   = changeRxnBounds(iJN1462_GLC_UR7_3,'EX_glc__D_e',-7.3,'u')     ;
...
% glucanate & 2-ketoglucanate secretion secretion rates constrained
    ...
    iJN1462_GLC_UR10_9  = changeRxnBounds(iJN1462_GLC_UR10_9,'EX_glc__D_e',-10.9,'u')   ;
    iJN1462_GLC_UR10_9  = changeRxnBounds(iJN1462_GLC_UR10_9,'EX_glcn_e',2.8,'u')       ;
    iJN1462_GLC_UR10_9  = changeRxnBounds(iJN1462_GLC_UR10_9,'EX_2dhglcn_e',2.6,'u')    ;
...
%C Sources = glucanate
    ...
    iJN1462_GLN_UR5_1   = changeRxnBounds(iJN1462_GLN_UR5_1,'EX_glcn_e',-5.1,'u')       ;
...
%Set Demand Options
     iJN1462_GLC_UR6_3       = setDemandBoundaries(iJN1462_GLC_UR6_3,   4   )   ;
     iJN1462_GLC_UR7_3       = setDemandBoundaries(iJN1462_GLC_UR7_3,   4   )   ;
     iJN1462_GLC_UR10_9      = setDemandBoundaries(iJN1462_GLC_UR10_9,  4   )   ;
     iJN1462_GLN_UR5_1       = setDemandBoundaries(iJN1462_GLN_UR5_1,   4   )   ;
     iJN1462_GLC_UR10_9      = setDemandBoundaries(iJN1462_GLC_UR10_9,  4   )   ;
     iJN1462_OCT_UR3_4       = setDemandBoundaries(iJN1462_OCT_UR3_4,   5   )    ;
